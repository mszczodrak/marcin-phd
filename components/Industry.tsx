...
const features: {
  ...
  visual?: React.ReactNode
    ...
    {
      title: "Tesla",
      description: "Accelerated transition to sustainable energy with industrial (Megapack) and residential (Powerwall) energy storage products as well as wireless vehicle charging.",
      image: "/images/tesla_projects.jpeg",
    },
    {
      title: "Google Brain Robotics",
      description: "Robots playing ping pong, Reinforcement Learning with Model Predictive Control and robotics teleoperation.",
      image: "/images/google_brain_ping_pong.webp",
    },
    {
      title: "Google X (now Intrinsic)",
      description: "AI meets Industry 4.0. Building the future of manufacturing with AI and robotics.",
    ...
    {
      title: "Nest",
      description: "Building a conscious home that takes care of people inside and the surrounding environment. Nest Learning Thermostat, Nest Protect, Nest Security and network protocols for smart home: Thread and Weave.",
      image: "/images/nest_home_security.webp",
    },
    {
      title: "Philips",
      description: "Helping to build the future of smart city with outdoor lighting products.",
